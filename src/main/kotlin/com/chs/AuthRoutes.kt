...
import com.chs.data.request.AuthRequest
import com.chs.data.responses.AuthResponse
import com.chs.data.user.User
import com.chs.data.user.UserDataSource
import com.chs.security.hashing.HashingService
import com.chs.security.hashing.SaltedHash
import com.chs.security.token.TokenClaim
...
fun Route.signUp(
    ...
    post("signup") {
        ...
        val arFieldsBlank = request.username.isBlank() || request.password.isBlank()
        val isPwTooshort = request.password.length < 8
        if (arFieldsBlank || isPwTooshort) {
